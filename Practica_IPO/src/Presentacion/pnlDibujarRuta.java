	...
	public pnlDibujarRuta() {
		setLayout(new BorderLayout(0, 0));
		{
			...
			}
			{
				...
				btnFauna.setIcon(new ImageIcon(pnlDibujarRuta.class.getResource("/Presentacion/Imagenes/animal_ico32.png")));
			...
			}
			{
				...
				btnFlora.setIcon(new ImageIcon(pnlDibujarRuta.class.getResource("/Presentacion/Imagenes/planta_ico32.png")));
			...
			}
			{
				...
				new ImageIcon(pnlDibujarRuta.class.getResource("/Presentacion/Imagenes/boton-x.png")));
		...
		imagFauna =
		 toolkit.getImage(getClass().getClassLoader().getResource("Presentacion/Imagenes/animal_ico32.png"));
		...
		imagFrio = toolkit.getImage(getClass().getClassLoader().getResource("Presentacion/Imagenes/frio.png"));
		 imagUbicacion =
		 toolkit.getImage(getClass().getClassLoader().getResource("Presentacion/Imagenes/ubicación_ico32.png"));
		...
		imagCursorFauna = toolkit
		 ...
		 imagCursorFlora =
		toolkit.getImage(getClass().getClassLoader().getResource("Presentacion/Cursores/planta_ico16.png"));
		...
		imagCursorUbicacion =
		toolkit.getImage(getClass().getClassLoader().getResource("Presentacion/Cursores/ubicación_ico16.png"));
		...
		CursorVip = toolkit.createCustomCursor(imagCursorFlora, new Point(0, 0),
		"CURSOR_FLORA");
		...
		CursorPagar = toolkit.createCustomCursor(imagCursorUbicacion, new Point(0, 0),
		"CURSOR_UBICACION");
